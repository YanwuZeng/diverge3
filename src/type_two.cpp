...
//	QMessageBox::information(NULL, "Type II Divergence", "Before ancestral_inference in Type II."); 

	ancestral_inference(t1, s1, a);
	ancestral_inference(t2, s2, b);
	
//	QMessageBox::information(NULL, "Type II Divergence", "After ancestral_inference in Type II."); 

//	QMessageBox::information(NULL, "Type II Divergence", "Before num_site_with_amino_acid_classify in Type II."); 
...
//	QMessageBox::information(NULL, "Type II Divergence", "After num_site_with_amino_acid_classify in Type II."); 
...
//	QMessageBox::information(NULL, "Type II Divergence", "Before while in Type II."); 
...
//	QMessageBox::information(NULL, "Type II Divergence", "After while in Type II."); 

	if (i >= maxIterNum)
	{
	    QMessageBox::critical(NULL, "Type II Divergence", "The Computing Number Exceeds the aximun Number of Iteration !"); 
	}
